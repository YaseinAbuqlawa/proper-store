...
mixin _$DashboardStatsModel {
 ...
 double get totalRevenue; int get totalOrders; int get totalCustomers; int get outOfStockCount; Map<String, int> get ordersByStatus; Map<String, double> get dailyRevenue; Map<String, double> get monthlyRevenue; List<TopSellingItemModel> get topSelling; List<TopSpenderModel> get topSpenders;@TimestampConverter() DateTime get lastUpdatedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DashboardStatsModel&&(identical(other.totalRevenue, totalRevenue) || other.totalRevenue == totalRevenue)&&(identical(other.totalOrders, totalOrders) || other.totalOrders == totalOrders)&&(identical(other.totalCustomers, totalCustomers) || other.totalCustomers == totalCustomers)&&(identical(other.outOfStockCount, outOfStockCount) || other.outOfStockCount == outOfStockCount)&&const DeepCollectionEquality().equals(other.ordersByStatus, ordersByStatus)&&const DeepCollectionEquality().equals(other.dailyRevenue, dailyRevenue)&&const DeepCollectionEquality().equals(other.monthlyRevenue, monthlyRevenue)&&const DeepCollectionEquality().equals(other.topSelling, topSelling)&&const DeepCollectionEquality().equals(other.topSpenders, topSpenders)&&(identical(other.lastUpdatedAt, lastUpdatedAt) || other.lastUpdatedAt == lastUpdatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,totalRevenue,totalOrders,totalCustomers,outOfStockCount,const DeepCollectionEquality().hash(ordersByStatus),const DeepCollectionEquality().hash(dailyRevenue),const DeepCollectionEquality().hash(monthlyRevenue),const DeepCollectionEquality().hash(topSelling),const DeepCollectionEquality().hash(topSpenders),lastUpdatedAt);

@override
String toString() {
  return 'DashboardStatsModel(totalRevenue: $totalRevenue, totalOrders: $totalOrders, totalCustomers: $totalCustomers, outOfStockCount: $outOfStockCount, ordersByStatus: $ordersByStatus, dailyRevenue: $dailyRevenue, monthlyRevenue: $monthlyRevenue, topSelling: $topSelling, topSpenders: $topSpenders, lastUpdatedAt: $lastUpdatedAt)';
}
...
@useResult
$Res call({
 double totalRevenue, int totalOrders, int totalCustomers, int outOfStockCount, Map<String, int> ordersByStatus, Map<String, double> dailyRevenue, Map<String, double> monthlyRevenue, List<TopSellingItemModel> topSelling, List<TopSpenderModel> topSpenders,@TimestampConverter() DateTime lastUpdatedAt
});
...
/// Create a copy of DashboardStatsModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? totalRevenue = null,Object? totalOrders = null,Object? totalCustomers = null,Object? outOfStockCount = null,Object? ordersByStatus = null,Object? dailyRevenue = null,Object? monthlyRevenue = null,Object? topSelling = null,Object? topSpenders = null,Object? lastUpdatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double totalRevenue,  int totalOrders,  int totalCustomers,  int outOfStockCount,  Map<String, int> ordersByStatus,  Map<String, double> dailyRevenue,  Map<String, double> monthlyRevenue,  List<TopSellingItemModel> topSelling,  List<TopSpenderModel> topSpenders, @TimestampConverter()  DateTime lastUpdatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DashboardStatsModel() when $default != null:
return $default(_that.totalRevenue,_that.totalOrders,_that.totalCustomers,_that.outOfStockCount,_that.ordersByStatus,_that.dailyRevenue,_that.monthlyRevenue,_that.topSelling,_that.topSpenders,_that.lastUpdatedAt);case _:
  return orElse();
...
class _DashboardStatsModel extends DashboardStatsModel {
  const _DashboardStatsModel({this.totalRevenue = 0.0, this.totalOrders = 0, this.totalCustomers = 0, this.outOfStockCount = 0, final  Map<String, int> ordersByStatus = const {}, final  Map<String, double> dailyRevenue = const {}, final  Map<String, double> monthlyRevenue = const {}, final  List<TopSellingItemModel> topSelling = const [], final  List<TopSpenderModel> topSpenders = const [], @TimestampConverter() required this.lastUpdatedAt}): _ordersByStatus = ordersByStatus,_dailyRevenue = dailyRevenue,_monthlyRevenue = monthlyRevenue,_topSelling = topSelling,_topSpenders = topSpenders,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DashboardStatsModel&&(identical(other.totalRevenue, totalRevenue) || other.totalRevenue == totalRevenue)&&(identical(other.totalOrders, totalOrders) || other.totalOrders == totalOrders)&&(identical(other.totalCustomers, totalCustomers) || other.totalCustomers == totalCustomers)&&(identical(other.outOfStockCount, outOfStockCount) || other.outOfStockCount == outOfStockCount)&&const DeepCollectionEquality().equals(other._ordersByStatus, _ordersByStatus)&&const DeepCollectionEquality().equals(other._dailyRevenue, _dailyRevenue)&&const DeepCollectionEquality().equals(other._monthlyRevenue, _monthlyRevenue)&&const DeepCollectionEquality().equals(other._topSelling, _topSelling)&&const DeepCollectionEquality().equals(other._topSpenders, _topSpenders)&&(identical(other.lastUpdatedAt, lastUpdatedAt) || other.lastUpdatedAt == lastUpdatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,totalRevenue,totalOrders,totalCustomers,outOfStockCount,const DeepCollectionEquality().hash(_ordersByStatus),const DeepCollectionEquality().hash(_dailyRevenue),const DeepCollectionEquality().hash(_monthlyRevenue),const DeepCollectionEquality().hash(_topSelling),const DeepCollectionEquality().hash(_topSpenders),lastUpdatedAt);
...
/// Create a copy of DashboardStatsModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? totalRevenue = null,Object? totalOrders = null,Object? totalCustomers = null,Object? outOfStockCount = null,Object? ordersByStatus = null,Object? dailyRevenue = null,Object? monthlyRevenue = null,Object? topSelling = null,Object? topSpenders = null,Object? lastUpdatedAt = null,}) {
