...
class _Initial implements ProductFormState {
  const _Initial();
...
class _Submitting implements ProductFormState {
  const _Submitting();
...
@override
String toString() {
  return 'ProductFormState.submitting()';
}
...
class _Success implements ProductFormState {
  const _Success();
...
@override
String toString() {
  return 'ProductFormState.success()';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $ProductFormStateCopyWith<$Res> {
