...
mixin _$ProductModel {
 ...
 String get category;@ColorVariantConverter() List<ColorVariant> get colors;@ColorVariantConverter() ColorVariant? get selectedColor; String get description; double get discountPercentage; double get discountValue; String get id;@JsonKey(includeToJson: false, includeFromJson: false) int get quantity; List<String> get imageUrls;@TimestampConverter() DateTime get lastPurchaseDate; String get material; String get name; int get refundedQuantity; String? get collection; String get section; double get sellingPrice; List<double> get sizes; int get soldQuantity; List<String> get videoUrls;
...
@useResult
$Res call({
 String category,@ColorVariantConverter() List<ColorVariant> colors,@ColorVariantConverter() ColorVariant? selectedColor, String description, double discountPercentage, double discountValue, String id,@JsonKey(includeToJson: false, includeFromJson: false) int quantity, List<String> imageUrls,@TimestampConverter() DateTime lastPurchaseDate, String material, String name, int refundedQuantity, String? collection, String section, double sellingPrice, List<double> sizes, int soldQuantity, List<String> videoUrls
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String category, @ColorVariantConverter()  List<ColorVariant> colors, @ColorVariantConverter()  ColorVariant? selectedColor,  String description,  double discountPercentage,  double discountValue,  String id, @JsonKey(includeToJson: false, includeFromJson: false)  int quantity,  List<String> imageUrls, @TimestampConverter()  DateTime lastPurchaseDate,  String material,  String name,  int refundedQuantity,  String? collection,  String section,  double sellingPrice,  List<double> sizes,  int soldQuantity,  List<String> videoUrls)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductModel() when $default != null:
return $default(_that.category,_that.colors,_that.selectedColor,_that.description,_that.discountPercentage,_that.discountValue,_that.id,_that.quantity,_that.imageUrls,_that.lastPurchaseDate,_that.material,_that.name,_that.refundedQuantity,_that.collection,_that.section,_that.sellingPrice,_that.sizes,_that.soldQuantity,_that.videoUrls);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String category, @ColorVariantConverter()  List<ColorVariant> colors, @ColorVariantConverter()  ColorVariant? selectedColor,  String description,  double discountPercentage,  double discountValue,  String id, @JsonKey(includeToJson: false, includeFromJson: false)  int quantity,  List<String> imageUrls, @TimestampConverter()  DateTime lastPurchaseDate,  String material,  String name,  int refundedQuantity,  String? collection,  String section,  double sellingPrice,  List<double> sizes,  int soldQuantity,  List<String> videoUrls)  $default,) {final _that = this;
switch (_that) {
case _ProductModel():
return $default(_that.category,_that.colors,_that.selectedColor,_that.description,_that.discountPercentage,_that.discountValue,_that.id,_that.quantity,_that.imageUrls,_that.lastPurchaseDate,_that.material,_that.name,_that.refundedQuantity,_that.collection,_that.section,_that.sellingPrice,_that.sizes,_that.soldQuantity,_that.videoUrls);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String category, @ColorVariantConverter()  List<ColorVariant> colors, @ColorVariantConverter()  ColorVariant? selectedColor,  String description,  double discountPercentage,  double discountValue,  String id, @JsonKey(includeToJson: false, includeFromJson: false)  int quantity,  List<String> imageUrls, @TimestampConverter()  DateTime lastPurchaseDate,  String material,  String name,  int refundedQuantity,  String? collection,  String section,  double sellingPrice,  List<double> sizes,  int soldQuantity,  List<String> videoUrls)?  $default,) {final _that = this;
switch (_that) {
case _ProductModel() when $default != null:
return $default(_that.category,_that.colors,_that.selectedColor,_that.description,_that.discountPercentage,_that.discountValue,_that.id,_that.quantity,_that.imageUrls,_that.lastPurchaseDate,_that.material,_that.name,_that.refundedQuantity,_that.collection,_that.section,_that.sellingPrice,_that.sizes,_that.soldQuantity,_that.videoUrls);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProductModel&&(identical(other.category, category) || other.category == category)&&const DeepCollectionEquality().equals(other._colors, _colors)&&(identical(other.selectedColor, selectedColor) || other.selectedColor == selectedColor)&&(identical(other.description, description) || other.description == description)&&(identical(other.discountPercentage, discountPercentage) || other.discountPercentage == discountPercentage)&&(identical(other.discountValue, discountValue) || other.discountValue == discountValue)&&(identical(other.id, id) || other.id == id)&&(identical(other.quantity, quantity) || other.quantity == quantity)&&const DeepCollectionEquality().equals(other._imageUrls, _imageUrls)&&(identical(other.lastPurchaseDate, lastPurchaseDate) || other.lastPurchaseDate == lastPurchaseDate)&&(identical(other.material, material) || other.material == material)&&(identical(other.name, name) || other.name == name)&&(identical(other.refundedQuantity, refundedQuantity) || other.refundedQuantity == refundedQuantity)&&(identical(other.collection, collection) || other.collection == collection)&&(identical(other.section, section) || other.section == section)&&(identical(other.sellingPrice, sellingPrice) || other.sellingPrice == sellingPrice)&&const DeepCollectionEquality().equals(other._sizes, _sizes)&&(identical(other.soldQuantity, soldQuantity) || other.soldQuantity == soldQuantity)&&const DeepCollectionEquality().equals(other._videoUrls, _videoUrls));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,category,const DeepCollectionEquality().hash(_colors),selectedColor,description,discountPercentage,discountValue,id,quantity,const DeepCollectionEquality().hash(_imageUrls),lastPurchaseDate,material,name,refundedQuantity,collection,section,sellingPrice,const DeepCollectionEquality().hash(_sizes),soldQuantity,const DeepCollectionEquality().hash(_videoUrls)]);
