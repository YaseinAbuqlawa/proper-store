...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,category,const DeepCollectionEquality().hash(variants),selectedColor,description,discountPercentage,discountValue,id,quantity,mainImageUrl,lastPurchaseDate,material,name,refundedQuantity,collection,section,sellingPrice,const DeepCollectionEquality().hash(sizes),shippedQuantity,totalStock,const DeepCollectionEquality().hash(outOfStockVariants),hasOutOfStockVariants]);

@override
String toString() {
  return 'ProductModel(category: $category, variants: $variants, selectedColor: $selectedColor, description: $description, discountPercentage: $discountPercentage, discountValue: $discountValue, id: $id, quantity: $quantity, mainImageUrl: $mainImageUrl, lastPurchaseDate: $lastPurchaseDate, material: $material, name: $name, refundedQuantity: $refundedQuantity, collection: $collection, section: $section, sellingPrice: $sellingPrice, sizes: $sizes, shippedQuantity: $shippedQuantity, totalStock: $totalStock, outOfStockVariants: $outOfStockVariants, hasOutOfStockVariants: $hasOutOfStockVariants)';
}
...
@useResult
$Res call({
 String category,@ProductVariantMapConverter() Map<String, ProductVariant> variants,@JsonKey(includeToJson: false, includeFromJson: false) ProductVariant? selectedColor, String description, double discountPercentage, double discountValue, String id,@JsonKey(includeToJson: false, includeFromJson: false) int quantity, String mainImageUrl,@TimestampConverter() DateTime lastPurchaseDate, String material, String name, int refundedQuantity, String? collection, String section, double sellingPrice, List<double> sizes, int shippedQuantity, int totalStock, List<String> outOfStockVariants, bool hasOutOfStockVariants
});
...
as List<double>,shippedQuantity: null == shippedQuantity ? _self.shippedQuantity : shippedQuantity // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String category, @ProductVariantMapConverter()  Map<String, ProductVariant> variants, @JsonKey(includeToJson: false, includeFromJson: false)  ProductVariant? selectedColor,  String description,  double discountPercentage,  double discountValue,  String id, @JsonKey(includeToJson: false, includeFromJson: false)  int quantity,  String mainImageUrl, @TimestampConverter()  DateTime lastPurchaseDate,  String material,  String name,  int refundedQuantity,  String? collection,  String section,  double sellingPrice,  List<double> sizes,  int shippedQuantity,  int totalStock,  List<String> outOfStockVariants,  bool hasOutOfStockVariants)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductModel() when $default != null:
return $default(_that.category,_that.variants,_that.selectedColor,_that.description,_that.discountPercentage,_that.discountValue,_that.id,_that.quantity,_that.mainImageUrl,_that.lastPurchaseDate,_that.material,_that.name,_that.refundedQuantity,_that.collection,_that.section,_that.sellingPrice,_that.sizes,_that.shippedQuantity,_that.totalStock,_that.outOfStockVariants,_that.hasOutOfStockVariants);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String category, @ProductVariantMapConverter()  Map<String, ProductVariant> variants, @JsonKey(includeToJson: false, includeFromJson: false)  ProductVariant? selectedColor,  String description,  double discountPercentage,  double discountValue,  String id, @JsonKey(includeToJson: false, includeFromJson: false)  int quantity,  String mainImageUrl, @TimestampConverter()  DateTime lastPurchaseDate,  String material,  String name,  int refundedQuantity,  String? collection,  String section,  double sellingPrice,  List<double> sizes,  int shippedQuantity,  int totalStock,  List<String> outOfStockVariants,  bool hasOutOfStockVariants)  $default,) {final _that = this;
switch (_that) {
case _ProductModel():
return $default(_that.category,_that.variants,_that.selectedColor,_that.description,_that.discountPercentage,_that.discountValue,_that.id,_that.quantity,_that.mainImageUrl,_that.lastPurchaseDate,_that.material,_that.name,_that.refundedQuantity,_that.collection,_that.section,_that.sellingPrice,_that.sizes,_that.shippedQuantity,_that.totalStock,_that.outOfStockVariants,_that.hasOutOfStockVariants);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String category, @ProductVariantMapConverter()  Map<String, ProductVariant> variants, @JsonKey(includeToJson: false, includeFromJson: false)  ProductVariant? selectedColor,  String description,  double discountPercentage,  double discountValue,  String id, @JsonKey(includeToJson: false, includeFromJson: false)  int quantity,  String mainImageUrl, @TimestampConverter()  DateTime lastPurchaseDate,  String material,  String name,  int refundedQuantity,  String? collection,  String section,  double sellingPrice,  List<double> sizes,  int shippedQuantity,  int totalStock,  List<String> outOfStockVariants,  bool hasOutOfStockVariants)?  $default,) {final _that = this;
switch (_that) {
case _ProductModel() when $default != null:
return $default(_that.category,_that.variants,_that.selectedColor,_that.description,_that.discountPercentage,_that.discountValue,_that.id,_that.quantity,_that.mainImageUrl,_that.lastPurchaseDate,_that.material,_that.name,_that.refundedQuantity,_that.collection,_that.section,_that.sellingPrice,_that.sizes,_that.shippedQuantity,_that.totalStock,_that.outOfStockVariants,_that.hasOutOfStockVariants);case _:
  return null;
...
@override final  int shippedQuantity;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,category,const DeepCollectionEquality().hash(_variants),selectedColor,description,discountPercentage,discountValue,id,quantity,mainImageUrl,lastPurchaseDate,material,name,refundedQuantity,collection,section,sellingPrice,const DeepCollectionEquality().hash(_sizes),shippedQuantity,totalStock,const DeepCollectionEquality().hash(_outOfStockVariants),hasOutOfStockVariants]);
