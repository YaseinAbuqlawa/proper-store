...
mixin _$ProductModel {
 ...
 String get category;@ProductVariantConverter() List<ProductVariant> get colors;@JsonKey(includeToJson: false, includeFromJson: false) ProductVariant? get selectedColor; String get description; double get discountPercentage; double get discountValue; String get id;@JsonKey(includeToJson: false, includeFromJson: false) int get quantity; String get mainImageUrl;@TimestampConverter() DateTime get lastPurchaseDate; String get material; String get name; int get refundedQuantity; String? get collection; String get section; double get sellingPrice; List<double> get sizes; int get soldQuantity; int get stockQuantity;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,category,const DeepCollectionEquality().hash(colors),selectedColor,description,discountPercentage,discountValue,id,quantity,mainImageUrl,lastPurchaseDate,material,name,refundedQuantity,collection,section,sellingPrice,const DeepCollectionEquality().hash(sizes),soldQuantity,stockQuantity]);

@override
String toString() {
  return 'ProductModel(category: $category, colors: $colors, selectedColor: $selectedColor, description: $description, discountPercentage: $discountPercentage, discountValue: $discountValue, id: $id, quantity: $quantity, mainImageUrl: $mainImageUrl, lastPurchaseDate: $lastPurchaseDate, material: $material, name: $name, refundedQuantity: $refundedQuantity, collection: $collection, section: $section, sellingPrice: $sellingPrice, sizes: $sizes, soldQuantity: $soldQuantity, stockQuantity: $stockQuantity)';
}
...
@useResult
$Res call({
 String category,@ProductVariantConverter() List<ProductVariant> colors,@JsonKey(includeToJson: false, includeFromJson: false) ProductVariant? selectedColor, String description, double discountPercentage, double discountValue, String id,@JsonKey(includeToJson: false, includeFromJson: false) int quantity, String mainImageUrl,@TimestampConverter() DateTime lastPurchaseDate, String material, String name, int refundedQuantity, String? collection, String section, double sellingPrice, List<double> sizes, int soldQuantity, int stockQuantity
});
...
/// Create a copy of ProductModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? category = null,Object? colors = null,Object? selectedColor = freezed,Object? description = null,Object? discountPercentage = null,Object? discountValue = null,Object? id = null,Object? quantity = null,Object? mainImageUrl = null,Object? lastPurchaseDate = null,Object? material = null,Object? name = null,Object? refundedQuantity = null,Object? collection = freezed,Object? section = null,Object? sellingPrice = null,Object? sizes = null,Object? soldQuantity = null,Object? stockQuantity = null,}) {
  return _then(_self.copyWith(
category: null == category ? _self.category : category // ignore: cast_nullable_to_non_nullable
as String,colors: null == colors ? _self.colors : colors // ignore: cast_nullable_to_non_nullable
as List<ProductVariant>,selectedColor: freezed == selectedColor ? _self.selectedColor : selectedColor // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String category, @ProductVariantConverter()  List<ProductVariant> colors, @JsonKey(includeToJson: false, includeFromJson: false)  ProductVariant? selectedColor,  String description,  double discountPercentage,  double discountValue,  String id, @JsonKey(includeToJson: false, includeFromJson: false)  int quantity,  String mainImageUrl, @TimestampConverter()  DateTime lastPurchaseDate,  String material,  String name,  int refundedQuantity,  String? collection,  String section,  double sellingPrice,  List<double> sizes,  int soldQuantity,  int stockQuantity)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String category, @ProductVariantConverter()  List<ProductVariant> colors, @JsonKey(includeToJson: false, includeFromJson: false)  ProductVariant? selectedColor,  String description,  double discountPercentage,  double discountValue,  String id, @JsonKey(includeToJson: false, includeFromJson: false)  int quantity,  String mainImageUrl, @TimestampConverter()  DateTime lastPurchaseDate,  String material,  String name,  int refundedQuantity,  String? collection,  String section,  double sellingPrice,  List<double> sizes,  int soldQuantity,  int stockQuantity)  $default,) {final _that = this;
switch (_that) {
case _ProductModel():
return $default(_that.category,_that.colors,_that.selectedColor,_that.description,_that.discountPercentage,_that.discountValue,_that.id,_that.quantity,_that.mainImageUrl,_that.lastPurchaseDate,_that.material,_that.name,_that.refundedQuantity,_that.collection,_that.section,_that.sellingPrice,_that.sizes,_that.soldQuantity,_that.stockQuantity);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String category, @ProductVariantConverter()  List<ProductVariant> colors, @JsonKey(includeToJson: false, includeFromJson: false)  ProductVariant? selectedColor,  String description,  double discountPercentage,  double discountValue,  String id, @JsonKey(includeToJson: false, includeFromJson: false)  int quantity,  String mainImageUrl, @TimestampConverter()  DateTime lastPurchaseDate,  String material,  String name,  int refundedQuantity,  String? collection,  String section,  double sellingPrice,  List<double> sizes,  int soldQuantity,  int stockQuantity)?  $default,) {final _that = this;
switch (_that) {
case _ProductModel() when $default != null:
return $default(_that.category,_that.colors,_that.selectedColor,_that.description,_that.discountPercentage,_that.discountValue,_that.id,_that.quantity,_that.mainImageUrl,_that.lastPurchaseDate,_that.material,_that.name,_that.refundedQuantity,_that.collection,_that.section,_that.sellingPrice,_that.sizes,_that.soldQuantity,_that.stockQuantity);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,category,const DeepCollectionEquality().hash(_colors),selectedColor,description,discountPercentage,discountValue,id,quantity,mainImageUrl,lastPurchaseDate,material,name,refundedQuantity,collection,section,sellingPrice,const DeepCollectionEquality().hash(_sizes),soldQuantity,stockQuantity]);
...
/// Create a copy of ProductModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? category = null,Object? colors = null,Object? selectedColor = freezed,Object? description = null,Object? discountPercentage = null,Object? discountValue = null,Object? id = null,Object? quantity = null,Object? mainImageUrl = null,Object? lastPurchaseDate = null,Object? material = null,Object? name = null,Object? refundedQuantity = null,Object? collection = freezed,Object? section = null,Object? sellingPrice = null,Object? sizes = null,Object? soldQuantity = null,Object? stockQuantity = null,}) {
