...
_ProductModel _$ProductModelFromJson(Map<String, dynamic> json) =>
    _ProductModel(
      ...
      colors: (json['colors'] as List<dynamic>)
          .map(
            (e) => const ColorVariantConverter().fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      selectedColor:
          _$JsonConverterFromJson<Map<String, dynamic>, ColorVariant>(
            json['selectedColor'],
            const ColorVariantConverter().fromJson,
          ) ??
          null,
...
Map<String, dynamic> _$ProductModelToJson(
  ...
  'colors': instance.colors.map(const ColorVariantConverter().toJson).toList(),
  'selectedColor': _$JsonConverterToJson<Map<String, dynamic>, ColorVariant>(
    instance.selectedColor,
    const ColorVariantConverter().toJson,
  ),
