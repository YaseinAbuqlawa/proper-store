...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<AddressModel> addresses)?  loaded,TResult Function( String failureMessage)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
return loaded(_that.addresses);case _Failure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<AddressModel> addresses)  loaded,required TResult Function( String failureMessage)  failure,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loading():
return loading();case _Loaded():
return loaded(_that.addresses);case _Failure():
return failure(_that.failureMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<AddressModel> addresses)?  loaded,TResult? Function( String failureMessage)?  failure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
...
class _Initial implements AddressesState {
  const _Initial();
...
class _Loading implements AddressesState {
  const _Loading();
...
class _Loaded implements AddressesState {
  const _Loaded({required final  List<AddressModel> addresses}): _addresses = addresses;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&const DeepCollectionEquality().equals(other._addresses, _addresses));
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $AddressesStateCopyWith<$Res> {
...
class _Failure implements AddressesState {
...
@override
String toString() {
  return 'AddressesState.failure(failureMessage: $failureMessage)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $AddressesStateCopyWith<$Res> {
