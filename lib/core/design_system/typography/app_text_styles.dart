...
class AppTextStyles {
  // Large headlines (e.g., main page header)
  ...
  // Section titles (e.g., Saving Packages, Best Sellers)
  ...
  // Current price (highlighted in gold)
  ...
  // Old or strikethrough price (muted)
  ...
  // Button text (e.g., Buy Now, Add to Cart)
  ...
  // Badge or small alert text (e.g., Special Offer, New)
  ...
  // Long product description (body text)
